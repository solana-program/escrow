...
pub struct AddTimelockAccounts<'a> {
...
impl<'a> TryFrom<&'a [AccountView]> for AddTimelockAccounts<'a> {
...
impl<'a> InstructionAccounts<'a> for AddTimelockAccounts<'a> {}
