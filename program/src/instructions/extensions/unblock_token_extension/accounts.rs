...
/// Accounts for the UnblockTokenExtension instruction
///
/// # Account Layout
/// 0. `[signer, writable]` payer - Included for consistency with extension mutation flows
/// 1. `[signer]` admin - Must match escrow.admin
/// 2. `[]` escrow - Escrow account to unblock extension on
/// 3. `[writable]` extensions - Extensions PDA
/// 4. `[]` system_program - System program
/// 5. `[]` event_authority - Event authority PDA
/// 6. `[]` escrow_program - Current program
pub struct UnblockTokenExtensionAccounts<'a> {
...
impl<'a> TryFrom<&'a [AccountView]> for UnblockTokenExtensionAccounts<'a> {
...
impl<'a> InstructionAccounts<'a> for UnblockTokenExtensionAccounts<'a> {}
